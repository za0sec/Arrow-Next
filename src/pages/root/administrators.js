...
export default function AdministratorsPage() {
    ...
    const handleDelete = async () => {
        try {
            await apiClient.delete(`/root/administrators/${adminToDelete.id}`, {
                headers: {
            ...
            alert(error.response?.data || 'Error al eliminar el administrador');
        }
    };
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <div className="mt-4">
                                    <p className="text-gray-300">
                                        ¿Estás seguro de que deseas eliminar a {adminToDelete?.firstName} {adminToDelete?.lastName}?
                                    </p>
                                    <p className="text-red-400 mt-2">
